...
const HomePage = () => (
  <main className="min-h-screen bg-background text-foreground">
    <section className="mx-auto grid w-full max-w-7xl gap-16 px-6 pb-28 pt-14 md:grid-cols-[1.05fr_0.95fr] md:gap-20 md:px-10 md:pb-36 md:pt-24">
      <div className="space-y-10 md:space-y-14">
        ...
        <div className="space-y-8">
          ...
          <p className="max-w-2xl text-4xl font-black uppercase leading-[0.95] md:text-6xl">DRIVE HEMSEDAL WITHOUT COMPLICATIONS.</p>
        </div>
      ...
      <div className="relative overflow-hidden rounded-3xl border border-border bg-secondary/30 p-3">
    ...
    <section className="border-y border-border bg-secondary/20">
      <div className="mx-auto w-full max-w-7xl space-y-14 px-6 py-20 md:px-10 md:py-28">
        ...
        <div className="space-y-6">
          ...
          <ul className="grid gap-4 md:grid-cols-2">
            {strengths.map((item) => (
              <li key={item} className="rounded-2xl border border-border bg-background px-6 py-6 text-xl font-semibold leading-snug">
                {item}
              </li>
            ))}
          </ul>
    ...
    <section className="mx-auto grid w-full max-w-7xl gap-20 px-6 py-20 md:grid-cols-2 md:px-10 md:py-28">
      <article className="space-y-6">
        <h3 className="text-4xl font-black uppercase leading-tight md:text-5xl">FOR SEASONAL WORKERS</h3>
      ...
      <article className="space-y-6">
        <h3 className="text-4xl font-black uppercase leading-tight md:text-5xl">FOR OCCASIONAL TRAVELLERS</h3>
    ...
    <section className="border-t border-border">
      <div className="mx-auto w-full max-w-7xl space-y-10 px-6 py-20 md:px-10 md:py-28">
        <h2 className="text-5xl font-black uppercase leading-[0.95] tracking-tight md:text-7xl">LOCAL. AVAILABLE. REAL.</h2>
        ...
        <p className="text-4xl font-black uppercase leading-tight md:text-6xl">DRIVE SMART. SPEND LESS. KEEP MOVING.</p>
      </div>
    </section>
  </main>
);
