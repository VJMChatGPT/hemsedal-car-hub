...
export const VehicleCard = ({ vehicle }: VehicleCardProps) => (
  ...
  >
    <div className="relative aspect-[4/3] overflow-hidden">
      ...
      />
      {vehicle.isFeatured && (
        <Badge className="absolute top-4 left-4 bg-accent text-accent-foreground font-semibold">Featured</Badge>
      )}
      {!vehicle.isAvailable && (
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        <div className="flex flex-col items-center text-center">
          ...
          <span className="text-sm text-muted-foreground">{vehicle.seats} Seats</span>
        </div>
        <div className="flex flex-col items-center text-center">
